...
Ядро системы статического анализа качества кода для студенческих работ на языке Python. Инструмент позволяет автоматически выявлять нарушения стандартов кодирования, архитектурные ошибки и потенциальные уязвимости.
